...
public class SampleGrid {
    private SparseMatrixZSampleGrid<SampleGridRenderer.WTWD> sampleGrid;
    private static final Logger LOG = LoggerFactory.getLogger(SampleGrid.class);
    ...
    public SparseMatrixZSampleGrid<SampleGridRenderer.WTWD> makeSampleGrid (ShortestPathTree spt) {
        long t0 = System.currentTimeMillis();
        sampleGrid = new SparseMatrixZSampleGrid<SampleGridRenderer.WTWD>(16, spt.getVertexCount(), dX, dY, coordinateOrigin);
     ...
     */
    public SparseMatrixZSampleGrid<SampleGridRenderer.WTWD>  makeSampleGridWithoutSPT (TObjectIntMap<Vertex> times) {
        long t0 = System.currentTimeMillis();
        sampleGrid = new SparseMatrixZSampleGrid<SampleGridRenderer.WTWD>(16, times.size(), dX, dY, coordinateOrigin);
