    ...
    */
    ...
    public int hashCode() {
        int hashCode = Double.valueOf(walkSpeed).hashCode() + Double.valueOf(bikeSpeed).hashCode()
                ...
                + Long.valueOf(clampInitialWait).hashCode() * 209477
                + Boolean.valueOf(reverseOptimizeOnTheFly).hashCode() * 95112799
                + Boolean.valueOf(ignoreRealtimeUpdates).hashCode() * 154329
                + Boolean.valueOf(disableRemainingWeightHeuristic).hashCode() * 193939
                + Boolean.valueOf(useTraffic).hashCode() * 10169;
        if (batch) {
            hashCode *= -1;
